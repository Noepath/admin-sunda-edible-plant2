    ...
    <div class="overflow-y-auto h-full">
        <form id="plantForm" action="{{ route('plants.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="manfaat_tanaman"
                          name="manfaat_tanaman"
                          rows="6"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
    ...
    <div class="flex flex-col min-h-full h-full">
        ...
        <div class="mb-6">
            ...
            <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="text-sm text-gray-700">
                            <label for="slide_images" class="cursor-pointer">
                                ...
                                <input id="slide_images" name="slide_images[]" type="file" class="sr-only" accept="image/*" multiple>
                            </label>
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <button type="button"
                            onclick="document.getElementById('slide_images').click()"
                            class="w-full bg-green-500 hover:bg-green-600 text-white text-sm py-2 px-4 rounded-md transition-colors">
                        Choose File
                    </button>
                </div>
